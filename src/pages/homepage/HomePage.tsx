      ...
      <div className="w-full">
        <div className="container w-full mx-auto py-[154px] h-[650px] flex items-center">
          <div className="w-1/2 flex flex-col gap-10">
            ...
            <button className="w-[191px] bg-c1 rounded-[20px] py-4 px-6 text-base font-medium text-c6">Start Shopping</button>
          </div>
          <div className="w-1/2 flex justify-end">
            <div className="w-[568px] h-[332px]">
              <div className="w-full h-full bg-c1 rounded-tl-[30px] rounded-bl-[30px] relative">
