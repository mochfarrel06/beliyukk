        ...
        <div className="container px-4 py-16">
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-c4 font-medium text-lg">Please see the clothes provided with a variety of interesting choices and something to buy</p>
            </div>
            <button className="bg-gradient-to-t from-c1 to-c3 px-6 py-4 rounded-lg font-semibold text-c4 w-44">Start Shopping</button>
          </div>
        </div>
      </div>
    </>
